...
# Invoke-WebRequest -Uri "https://moonrepo.dev/install/proto.ps1" -OutFile "proto.ps1"
...
$env:PATH += ";$HOME\.proto\bin"
Write-Output "Added $BinPath path to system path temporarily."